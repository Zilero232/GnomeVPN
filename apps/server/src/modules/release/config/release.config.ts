...
export const githubAssetUrl = (assetId: number): string => `${GITHUB_REPO_URL}/releases/assets/${assetId}`;
...
export const PLATFORM_EXTENSION_PRIORITY = ['exe', 'msi', 'dmg', 'appimage', 'deb', 'rpm', 'apk'];
