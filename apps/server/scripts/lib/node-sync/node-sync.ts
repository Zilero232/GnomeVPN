...
const buildNodeSync = (nodes: SyncableNode[]): string => {
  ...
  return [
    ...
    '  port = i.port, server_name = i.server_name, auth = i.auth,',
    ...
    '',
    'INSERT INTO node (',
    '  country, country_code, city, host, port, server_name, auth,',
    '  api_url, api_token_env_var, display_order, is_available',
    ')',
    'SELECT',
    '  i.country, i.country_code, i.city, i.host, i.port, i.server_name, i.auth,',
